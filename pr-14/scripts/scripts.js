...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        const currencyUl = document.querySelector('ul[aria-labelledby="currency-container"]');
        const conversionCurrencyUl = document.querySelector('ul[aria-labelledby="conversion-currency-container"]');
        UIController.populateCurrencyOptions(currencies, currencyUl, conversionCurrencyUl);
        ...
        const conversionCurrencySpan = document.querySelector('#conversion-currency-span');
        UIController.handleFormSubmission(form, currencySpan, conversionCurrencySpan);
